...
class Lstm:
    ...
    def train(self, files, batch_size=100, num_epochs=200):
        ...
        try:
            print ('lstm, dataset=Nottingham, lr=%f, epoch=%i' %(self.lr, num_epochs))
            ...
            for epoch in range(num_epochs):
                ...
                if (epoch%100 == 0):
                    ...
                    midiwrite('sample/lstm_%i.mid' %(epoch), piano_roll, self.r, self.dt)
                sys.stdout.flush()
...
def test_lstm(batch_size=256, num_epochs=500):
    model = Lstm()
