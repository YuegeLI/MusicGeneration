...
class Rnn:
    def __init__(self, n_hidden_recurrent = 40, lr = 0.1, r = (21, 109), dt = 0.3):
    ...
    def train(self, files, batch_size=100, num_epochs=200):
        ...
        try:
            print ('rnn, dataset=Nottingham, lr=%f, epoch=%i' %(self.lr, num_epochs))
            ...
            for epoch in range(num_epochs):
                ...
                if (epoch%100 == 0 or epoch == num_epochs-1):
                    ...
                    midiwrite('sample/rnn_%i.mid' %(epoch), piano_roll, self.r, self.dt)
                sys.stdout.flush()
